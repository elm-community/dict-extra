...
var _user$project$Dict_Extra$removeWhen = F2(
	function (pred, dict) {
		return A2(
			_elm_lang$core$Dict$filter,
			F2(
		...
		[
			...
			A2(
				...
				_elm_lang$core$Dict$fromList(
					_elm_lang$core$Native_List.fromArray(
						[
							{ctor: '_Tuple2', _0: 'Jack', _1: 2}
						])),
				A2(
					_user$project$Dict_Extra$removeWhen,
					F2(
						function (_p0, v) {
							return _elm_lang$core$Native_Utils.eq(v, 1);
						}),
					_elm_lang$core$Dict$fromList(
						_elm_lang$core$Native_List.fromArray(
							[
								{ctor: '_Tuple2', _0: 'Mary', _1: 1},
								{ctor: '_Tuple2', _0: 'Jack', _1: 2},
								{ctor: '_Tuple2', _0: 'Jill', _1: 1}
							])))))
		]));
var _user$project$Test$GroupByData = F2(
	function (a, b) {
		return {groupId: a, name: b};
	});
var _user$project$Test$mary = A2(_user$project$Test$GroupByData, 1, 'Mary');
var _user$project$Test$jack = A2(_user$project$Test$GroupByData, 2, 'Jack');
var _user$project$Test$jill = A2(_user$project$Test$GroupByData, 1, 'Jill');
var _user$project$Test$groupByTests = A2(
	_elm_community$elm_test$ElmTest$suite,
	'groupBy',
	_elm_lang$core$Native_List.fromArray(
		[
			...
			A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_0: 2,
						_1: _elm_lang$core$Native_List.fromArray(
							[_user$project$Test$jack])
					}
					]),
				_elm_lang$core$Dict$toList(
					A2(
						_user$project$Dict_Extra$groupBy,
						function (_) {
							return _.groupId;
						},
						_elm_lang$core$Native_List.fromArray(
							[_user$project$Test$mary, _user$project$Test$jack, _user$project$Test$jill])))))
		]));
var _user$project$Test$tests = A2(
	_elm_community$elm_test$ElmTest$suite,
	'Dict tests',
	_elm_lang$core$Native_List.fromArray(
		[_user$project$Test$groupByTests, _user$project$Test$removeWhenTests]));
